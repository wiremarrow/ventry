...
export default function PurchaseOrdersPage() {
  ...
  const [statusFilter, setStatusFilter] = useState<
    'DRAFT' | 'SUBMITTED' | 'APPROVED' | 'PARTIAL' | 'RECEIVED' | 'CANCELLED' | 'all'
  >('all');
  ...
  const stats = {
    ...
    totalValue:
      orders?.purchaseOrders?.reduce((sum, o) => sum + parseFloat(o.total.toString()), 0) || 0,
  };
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {order.status === 'SUBMITTED' && (
                              <>
                                <DropdownMenuItem
                                  onClick={() =>
                                    approveMutation.mutate({ poId: order.id, action: 'APPROVE' })
                                  }
